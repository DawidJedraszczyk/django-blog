...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        profile_images_dir = "examples/profile_images/"
        ...
        followings = []
        for user in users:
            num_followings = random.randint(5, 20)
        ...
        posts = []
        for user in users:
            num_posts = random.randint(1, num_posts_per_user)
        ...
        bu = BlogUser.objects.first()
        self.stdout.write(f"Login: {bu.username}")
